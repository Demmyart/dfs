    ...
    public class ClientController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Upload([FromUri] string path, [FromUri] string name, [FromUri] string user)
        {
            ...
            try
            {
                ...
                Console.WriteLine(String.Format("fileReg?path={0}&name={1}&id={2}&size={3}&user={4}",
                                                                   path,
                                                                   name,
                ...
                var response = Api.Get(FileSystem.NameServerAddress, String.Format("fileReg?path={0}&name={1}&id={2}&size={3}&user={4}",
                                                                   path,
                                                                   name,
                                                                   FileSystem.StorageID,
                                                                   size.ToString(),
